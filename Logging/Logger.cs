namespace StellarAdvisorCore.Logging
{
    public static class Logger
    {
        ...
        public static void LogSuccess(string successMessage) => Console.WriteLine(_options.FormatLogMessage(successMessage, _options.SuccessColor, "Success"));
        ...
        public static async Task LogSuccessAsync(string successMessage) => await Console.Out.WriteLineAsync(_options.FormatLogMessage(successMessage, _options.SuccessColor, "Success"));
